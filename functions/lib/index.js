...
exports.manualMigrateAccount = exports.moveApprovedAccountsToUsers = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
admin.initializeApp();
const db = admin.firestore();
exports.moveApprovedAccountsToUsers = functions
    .region('us-central1')
    .firestore
    ...
    try {
        ...
        throw new functions.https.HttpsError('internal', `Failed to move account ${docId} to users collection`, { originalError: error instanceof Error ? error.message : String(error) });
    }
});
exports.manualMigrateAccount = functions
    .region('us-central1')
    .https
    ...
    try {
        ...
        throw new functions.https.HttpsError('internal', `Failed to manually migrate account ${docId}`, { originalError: error instanceof Error ? error.message : String(error) });
    }
});
